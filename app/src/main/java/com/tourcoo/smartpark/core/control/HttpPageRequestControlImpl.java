...
public class HttpPageRequestControlImpl implements HttpPageRequestControl {

    private static String TAG = "HttpRequestControlImpl";

    @Override
    public void httpRequestSuccess(IHttpPageRequestControl httpRequestControl, List<?> dataList, OnHttpDataListener httpDataListener) {
    ...
    @Override
    public void httpRequestError(IHttpPageRequestControl httpRequestControl, @NonNull Throwable e) {
