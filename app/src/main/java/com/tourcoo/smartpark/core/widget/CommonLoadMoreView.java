package com.tourcoo.smartpark.core.widget;
...
public class CommonLoadMoreView extends LoadMoreView {
    ...
    protected int getLoadingViewId() {
        return R.id.llLoadingLoadMore;
    }

    @Override
    protected int getLoadFailViewId() {
        return R.id.llLoadFailLoadMore;
    }

    @Override
    protected int getLoadEndViewId() {
        return R.id.fLLoadEndLoadMore;
    }
    ...
    public static final class Builder {
        ...
        public Builder(CommonLoadMoreView fastLoadMoreView) {
        ...
        public CommonLoadMoreView build() {
            return new CommonLoadMoreView(this);
        }
    }

    public CommonLoadMoreView(@Nullable Context context) {
        this(new Builder(context));
    }
    CommonLoadMoreView(Builder builder) {
    ...
    private void initView(BaseViewHolder holder) {
        ...
        holder.setText(R.id.tv_loadingFastLoadMore, mLoadingText)
                ...
                .setText(R.id.tv_loadFailLoadMore, mLoadFailText)
                .setTextColor(R.id.tv_loadFailLoadMore, mLoadFailTextColor)
                .setText(R.id.tv_loadEndLoadMore, mLoadEndText)
                .setTextColor(R.id.tv_loadEndLoadMore, mLoadEndTextColor);
        TextView tvLoading = holder.getView(R.id.tv_loadingFastLoadMore);
        TextView tvLoadFail = holder.getView(R.id.tv_loadFailLoadMore);
        TextView tvLoadEnd = holder.getView(R.id.tv_loadEndLoadMore);
        ProgressBar pbLoading = holder.getView(R.id.pb_loadingLoadMore);
