...
package com.tourcoo.smartpark.widget.progress;
...
import com.tourcoo.smartpark.util.ThemeUtils;
...
public class HorizontalProgressView extends View {
        ...
        if (textVisibility) {
            ...
            if (isTextMoved) {
                canvas.drawText(progressText,
                        (getWidth() - getPaddingLeft() - getPaddingRight() - SizeUtil.dp2px(28)) * (moveProgress / 100) + SizeUtil.dp2px(10),
    ...
    public void setTrackWidth(int width) {
        this.mTrackWidth = SizeUtil.dp2px(width);
        refreshTheView();
    }
    ...
    public void setProgressTextSize(int size) {
        mProgressTextSize = SizeUtil.sp2px(size);
        refreshTheView();
    }
    ...
    public void setProgressCornerRadius(int radius) {
        this.mCornerRadius = SizeUtil.dp2px(radius);
        refreshTheView();
    }
    ...
    public void setProgressTextPaddingBottom(int offset) {
        this.mTextPaddingBottomOffset = SizeUtil.dp2px(offset);
    }
